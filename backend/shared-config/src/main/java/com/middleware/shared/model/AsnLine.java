...
public class AsnLine extends BaseEntity {
    ...
    @JoinColumn(name = "header_asn_id", nullable = false)
    @JsonBackReference
    ...
    @Column(name = "asn_detail_status", nullable = false)
    private Integer asnDetailStatus = 4;
    ...
    @Column(name = "asn_recv_rules", length = 200)
    private String asnRecvRules;
